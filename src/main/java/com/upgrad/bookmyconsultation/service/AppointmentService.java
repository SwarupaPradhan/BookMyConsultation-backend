...
public class AppointmentService {
	...
	public String appointment(Appointment appointment) throws InvalidInputException {
		...
		appointment = appointmentRepository.findByDoctorIdAndTimeSlotAndAppointmentDate(appointment.getDoctorId(),appointment.getTimeSlot(),appointment.getAppointmentDate());
		if(appointment == null){
